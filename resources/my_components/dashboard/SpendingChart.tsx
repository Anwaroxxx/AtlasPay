      ...
      <div className="mt-4 h-56 w-full">
        <ResponsiveContainer>
          <BarChart data={data} margin={{ top: 10, right: 8, left: -10, bottom: 0 }}>
            ...
            <XAxis dataKey="c" stroke="var(--color-muted-foreground)" fontSize={11} tickLine={false} axisLine={false} />
            ...
            />
            <Bar dataKey="v" fill="var(--color-primary)" radius={[8, 8, 0, 0]} maxBarSize={36} />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </div>
