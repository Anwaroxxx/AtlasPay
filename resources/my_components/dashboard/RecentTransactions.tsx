...
const tx = [
  { name: "Café Atlas", cat: "Café", icon: Coffee, amount: -42, time: "Today · 09:14" },
  { name: "Marjane Rabat", cat: "Shopping", icon: ShoppingBag, amount: -348, time: "Today · 08:02" },
  { name: "Salaire — TechCorp", cat: "Income", icon: ArrowDownLeft, amount: 12500, time: "Yesterday" },
  { name: "Lydec", cat: "Bills", icon: Zap, amount: -284, time: "May 03" },
  { name: "InDrive", cat: "Transport", icon: Car, amount: -55, time: "May 02" },
];
