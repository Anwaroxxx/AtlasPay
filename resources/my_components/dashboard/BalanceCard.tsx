import { Eye, EyeOff, ArrowUpRight, ArrowDownLeft, QrCode, Sparkles } from "lucide-react";
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl bg-[image:var(--gradient-primary)] p-6 text-primary-foreground shadow-[var(--shadow-elevated)]">
      ...
      <div className="relative flex items-start justify-between">
        <div>
          <p className="text-xs uppercase tracking-[0.2em] text-primary-foreground/70">Main account</p>
          <p className="mt-1 text-sm text-primary-foreground/80">MA53 ATLS 0009 8821 4477</p>
        </div>
        <button
      ...
      <div className="relative mt-8">
        ...
        <div className="mt-1 flex items-baseline gap-2">
          ...
          <span className="text-base font-medium text-primary-foreground/80">.45 MAD</span>
        </div>
      </div>
