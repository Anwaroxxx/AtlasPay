        ...
        <div className="mx-auto w-full max-w-6xl px-4 py-6 md:px-6 md:py-8">
            <header className="flex flex-wrap items-end justify-between gap-3">
                <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">
                        Locked savings, deducted automatically every month.
                    </p>
                </div>
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-3">
                <div className="rounded-2xl bg-[image:var(--gradient-primary)] p-5 text-primary-foreground shadow-[var(--shadow-elevated)]">
                    <p className="text-xs tracking-wider text-primary-foreground/70 uppercase">
                        Vault total
                    </p>
                    ...
                    <p className="mt-1 text-xs text-primary-foreground/80">
                        Across {goals.length} goals · locked
                    </p>
                </div>
                ...
                <div className="rounded-2xl border border-border bg-card p-5 shadow-[var(--shadow-soft)]">
                    ...
                    <p className="mt-2 font-display text-3xl font-semibold">
                        {Math.round(
                            (goals.reduce((s, g) => s + g.saved / g.target, 0) /
                                goals.length) *
                                100,
                        )}
                        %
                        ...
                        >
                            ...
                            <div className="mt-4">
                                ...
                                <div className="mt-2 flex justify-between text-[11px] text-muted-foreground">
                                    ...
                                    <span>
                                        {g.monthly.toLocaleString()} MAD / month
                                    </span>
                                </div>
                            </div>
