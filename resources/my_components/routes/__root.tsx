    ...
    head: () => ({
        meta: [
            ...
            { title: 'AtlasPay — Modern Moroccan Banking' },
            {
                name: 'description',
                content:
                    'AtlasPay: QR payments, AutoCut savings, AI Financial Twin and Daret groups for Morocco.',
            },
                    ...
                    <div className="flex min-w-0 flex-1 flex-col">
                        <header className="sticky top-0 z-30 flex h-14 items-center gap-3 border-b border-border bg-background/80 px-3 backdrop-blur-xl md:h-16 md:px-6">
                            ...
                            <div className="ml-auto flex items-center gap-1.5">
                                <button className="hidden h-9 items-center gap-2 rounded-full border border-border bg-card px-3 text-xs text-muted-foreground hover:text-foreground md:inline-flex">
