            ...
            >
                ...
                >
                    <div className="group relative">
                        <div className="flex h-24 w-24 items-center justify-center overflow-hidden rounded-full border-4 border-background bg-primary text-3xl font-bold text-primary-foreground shadow-lg">
                            {user.profile_photo ? (
                                <img
                        ...
                        <button
                            ...
                            className="absolute right-0 bottom-0 flex h-8 w-8 items-center justify-center rounded-full border-2 border-background bg-primary text-primary-foreground shadow-md transition-transform hover:scale-110"
                        >
                            ...
                            >
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-[10px] text-muted-foreground italic">
                                        Government ID cannot be changed once
                                        verified.
                                    </p>
                                    <InputError
                                        message={errors.government_id}
                                    />
                                </div>
