...
*/
export const photo = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/settings/profile/photo'
*/
photo.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: photo.url(options),
    method: 'post',
})
...
* @route '/settings/profile/photo'
*/
const photoForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/settings/profile/photo'
*/
photoForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: photo.url(options),
    method: 'post',
})
...
* @see app/Http/Controllers/Settings/ProfileController.php:65
* @route '/settings/profile'
*/
